...
from django_rest_template.apps.common.templatetags.filters import translate_for_venue
from django_rest_template.apps.user.utils import UserCustomTemplate
from django_rest_template.apps.venue.models import Venue
...
class WelcomeEmail(ContextEmailMessage):
	...
	def get_subject(self):
		return 'Welcome to Django Rest Template'
...
class VerifyUserEmail(ContextEmailMessage):
	...
	def get_subject(self):
		return 'Email Verification for Django Rest Templates'
